            ...
            <main>
				...
				try {
                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        //sql to retriev user details
                        $userSQL = "SELECT firstname, surname 
                            FROM epicare_users 
                            WHERE user_id = $user_id";

                        //exxecite query
                        $userResult = $dbConn->query($userSQL);
                        $user = $userResult->fetchObject();
                        ...
                        if ($user) {
                            ...
                            //sql to retrieve user's event details
                            $eventSQL = "SELECT event_type, event_date
                                FROM epicare_events
                                WHERE user_id = $user_id";

                            //execute query
                            $eventResult = $dbConn->query($eventSQL);

                            //number of events
                            $numEvents = $eventResult->rowCount();
                            ...
                            echo "<p class='total'>Total Events: $numEvents</p>";
                            ...
                            echo "<table>
                                ...
                                while ($event = $eventResult->fetchObject()) {
                                    echo "<tr>
                        ...
                        echo "<h1 class='profile-error text-center'>There was a problem retrieving your details.</h1>\n";
                    ...
                    echo "<p class='profile-error text-center'>Please tyy <a href='profile.php'>try again</a></p>";
