        ...
        <div class="container-main">
            <nav>
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="myinfo" class="nav-link">My info</a></li>
            ...
            <main>
                ...
                $hiddenDateTime = filter_has_var(INPUT_POST, 'hiddenDateTime') ? $_POST['hiddenDateTime']: null;
                $message = filter_has_var(INPUT_POST, 'message') ? $_POST['message']: null;

                //Remove whitespace from data
                $hiddenDateTime= trim($hiddenDateTime);
				...
				try {
                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        //sql to insert message into epicare_community
                        $insertSQL = "INSERT INTO epicare_community (user_id, message, comm_date) VALUES (:user_id, :message, :comm_date)";

                        //Execute query
                        $stmt = $dbConn->prepare($insertSQL);
                        $stmt->execute(array(':user_id' => $user_id, ':message' => $message, ':comm_date' => $hiddenDateTime));
                    ...
                    echo "<h1 class='profile-error text-center'>There was a problem posting your message.</h1>\n";
